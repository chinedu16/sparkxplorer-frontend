    ...
    <div class="border-b border-gray-four py-8 space-y-6">
      <div class="flex">
        ...
        <div class="w-2/5 space-y-6">
          <el-checkbox v-model="formData.notification_performance" size="large">
            <div class="">
              <h3 class="font-semibold">Performance Update</h3>
              <p class="text-gray-one mt-2 font-normal">
                You will be notified via email about your scholar’s performance.
              </p>
            </div>
          </el-checkbox>
          <el-checkbox v-model="formData.notification_login" size="large">
            <div class="">
              <h3 class="font-semibold">Login Alert</h3>
              <p class="text-gray-one mt-2 font-normal">
                You will be notified via email when you or your scholars login.
              </p>
            </div>
          </el-checkbox>
        </div>
