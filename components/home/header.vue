<template>
  <header
    class="bg-primary-light w-full flex-shrink-0 px-4 md:px-6 xl:px-0 text-foreground"
  >
    <div
      class="max-w-screen-xl flex items-center w-full h-16 mx-auto md:h-20 justify-between"
    >
      <!-- Logo -->
      ...
      <ui-button
        ...
        size="icon"
        variant="ghost"
        class="rounded-full hover:bg-primary/5 lg:hidden focus-visible:ring-primary"
        @click="openMenu"
      >
          ...
          <ui-dropdown-menu-content class="w-48">
            <ui-dropdown-menu-item class="p-0">
              <ui-button
                ...
                variant="ghost"
                size="sm"
                class="gap-4 w-full rounded-none"
              >
    ...
    <Teleport to="body">
      <Transition name="slide">
        ...
        >
          <div
            :class="[
              'py-6 h-screen bg-primary-light duration-500 ease-in-out z-40 relative w-72 transition-transform font-semibold',
