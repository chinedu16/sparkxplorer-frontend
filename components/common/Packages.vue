            ...
            <div class="lg:flex justify-between lg:space-x-20 items-center">
              <div class="lg:w-3/6">
                ...
                <p class="text-sm lg:text-xl mt-5">
                  ...
                  beneficiaries, receipt and serial number for tax purposes,
            ...
            <div class="lg:flex justify-between lg:space-x-20 items-center">
              ...
              <div class="lg:w-3/6">
                ...
                <p class="text-sm lg:text-xl mt-5">
                  ...
                  thank you letter from beneficiaries, receipts and serial
                  number for tax purposes, contact details of the beneficiaries
            ...
            <div class="lg:flex justify-between lg:space-x-20 items-center">
              ...
              <div class="lg:w-3/6">
                ...
                <p class="text-sm lg:text-xl mt-5">
                  ...
                  engaging academic practice sessions and involves active
                  parental participation. We need a user-friendly and visually
                  appealing website that facilitates easy registration, provides
                  program details, encourages community engagement, and supports
                  donation options.
                </p>
            ...
            <div class="lg:flex justify-between lg:space-x-20 items-center">
              <div class="lg:w-3/6">
                ...
                <p class="text-sm lg:text-xl mt-5">
                  ...
                  recognition on devices, video messages from recipients, social
                  media acknowledgement and an impact report. A payment plan
                  option of 20 slots at $325 each for co-sponsorship.
                </p>
